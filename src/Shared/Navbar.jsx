    ...
    return (
        ...
        <div className="navbar bg-transparent h-44">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li className='text-2xl font-light'><Link to='/home'>Home</Link></li>
                        <li className='text-2xl font-light'><Link to='/projects'>Projects</Link></li>
                        <li className='text-2xl font-light'><Link to='/About'>About Us</Link></li>
            ...
            <div className="navbar-end gap-2">
                <Link to='/login'><p className="cursor-pointer bg-lime-500 text-gray-100 text-xl rounded-3xl py-3 px-9">{
                    user?.email ? <><FaUser></FaUser></> : 'Register'
                }</p></Link>
                {
                    user?.email && <button onClick={logOutHandle} className='cursor-pointer bg-lime-500 text-gray-100 rounded-3xl py-2 px-5'>Log out</button>
                }
            </div>
        </div>
